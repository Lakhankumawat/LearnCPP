...
void Merge(int A[], int low, int mid, int high) // A â€“ input array, low â€“ lower index, high â€“ higher index
{ int i,j,k,t[high-low+1],n=high-low+1;
// t is a temporary array
 // i used for indexing array tÍ¾j and k used for indexing on array A
