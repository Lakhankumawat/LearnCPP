...
- Recursively call the mirror function on all the children of the root of the generic tree which would give.
- Reverse the families of its children using the following code,
